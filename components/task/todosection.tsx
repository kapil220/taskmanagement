...
const ToDoSection: React.FC<ToDoSectionProps> = ({ section, addTask }) => {
  const { t } = useTranslation('common');

  return (
    <div className="w-1/4 mb-5">
      <div className="p-4 rounded-lg border-2 border-orange-500 flex items-center justify-between mb-4 shadow-xl">
