...
interface PlanningSectionProps {
  ...
  /*  updateTask: (updatedTask: TaskType, sectionId: number) => void;
  deleteTask: (taskId: string, sectionId: number) => void;
  duplicateTask: (task: TaskType, sectionId: number) => void;    */
}
...
const PlanningSection: React.FC<PlanningSectionProps> = ({
  ...
  return (
    <div className="w-1/4 mb-5">
      <div className="p-4 rounded-lg border-2 border-red-500 flex items-center justify-between mb-4 shadow-xl">
